...
struct ULiveLinkXRDDDSettings;

class ILiveLinkClient;

class LIVELINKXRDDD_API FLiveLinkXRDDDSource : public ILiveLinkSource, public FRunnable, public TSharedFromThis<FLiveLinkXRDDDSource>
{
public:

	FLiveLinkXRDDDSource(const FLiveLinkXRDDDConnectionSettings& ConnectionSettings);

	virtual ~FLiveLinkXRDDDSource();
	...
	virtual TSubclassOf<ULiveLinkSourceSettings> GetSettingsClass() const override { return ULiveLinkXRDDDSourceSettings::StaticClass(); }
